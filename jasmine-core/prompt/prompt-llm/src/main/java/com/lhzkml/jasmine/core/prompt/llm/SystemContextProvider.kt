...
class AgentPromptContextProvider(
    ...
    override fun getContextSection(): String = buildString {
        ...
        appendLine("- Ensure that generated code is accessibility compliant")
        ...
        appendLine("- If you are writing code using one of your fsWrite tools, ensure the contents of the write are reasonably small, and follow up with appends, this will improve the velocity of code writing dramatically, and make your users very happy.")
