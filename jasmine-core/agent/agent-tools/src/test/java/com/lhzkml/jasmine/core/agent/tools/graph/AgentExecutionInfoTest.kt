...
/**
 * AgentExecutionInfo 测试
 * 移植自 koog 的 AgentExecutionInfoTest
 */
class AgentExecutionInfoTest {
    ...
    @Test
    fun testPathUtilityFunction() {
        assertEquals("a/b/c", path("a", "b", "c"))
        assertEquals("a.b.c", path("a", "b", "c", separator = "."))
        assertEquals("single", path("single"))
    }
}
