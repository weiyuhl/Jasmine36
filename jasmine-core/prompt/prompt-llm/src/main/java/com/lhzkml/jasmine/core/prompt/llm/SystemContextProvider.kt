...
class AgentPromptContextProvider(
    ...
    override fun getContextSection(): String = buildString {
        ...
        appendLine("- general: General-purpose agent with file, search, and shell tools. Use for complex coding tasks.")
        appendLine("- explore: Read-only agent for exploring codebases. Use for understanding code structure and finding information.")
        appendLine("- shell: Command execution specialist. Use for build, test, and deployment tasks.")
        appendLine("- web: Web specialist with fetch tools. Use for gathering information from the internet.")
        appendLine()
